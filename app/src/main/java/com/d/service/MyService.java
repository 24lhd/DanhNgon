...
import static com.d.adaptor.AdaptorDanhNgon.draw;
...
//        params.y = 100;
        ...
        Glide.with(this).load(draw[random.nextInt(draw.length-1)]).into(img);
        ...
        btChiaSe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                screenShort.shareImageByFile(screenShort.takeSreenShortByView(relativeLayout,MyService.this),MyService.this);
                stopSelf();
